                ...
                try:
                    ...
                    if isinstance(games_list, list):
                        ...
                        for game in games_list:
                            card_row.controls.append(ui.create_game_card(game))
...
def main(page: ft.Page):
    ...
    def copy_chat_history(chat_history):
        ...
        page.run_task(ft.Clipboard().set, full_log)
    ...
    def load_stats_thread():
        try:
            ...
            for status, count in status_counts.items():
                if count > 0:
                    color = ui.get_status_color(status)
                    pie_sections.append(
                        ftc.PieChartSection(
                            count,
                            title=f"{status}\n{count}",
        ...
        controls=[
            ...
            ft.Column(
                ...
                controls=[
                     # Metrics
                     ft.Row([
                         ui.create_metric_card("Total Games", vs_metric_games, ft.Icons.GAMES),
                         ui.create_metric_card("Lifetime Hours", vs_metric_hours, ft.Icons.ACCESS_TIME),
                         ui.create_metric_card("Backlog Debt", vs_metric_backlog, ft.Icons.MONEY_OFF, ft.Colors.RED)
